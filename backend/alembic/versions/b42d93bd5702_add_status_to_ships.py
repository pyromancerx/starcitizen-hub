...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('type', sa.Enum('MEMBER_JOINED', 'MEMBER_APPROVED', 'OPERATION_CREATED', 'OPERATION_COMPLETED', 'SHIP_ADDED', 'TRADE_COMPLETED', 'CONTRACT_POSTED', 'CONTRACT_COMPLETED', 'ANNOUNCEMENT_POSTED', 'PROJECT_CREATED', 'PROJECT_COMPLETED', 'CONTRIBUTION_MADE', 'ACHIEVEMENT_EARNED', 'LFG_POSTED', 'PRICE_REPORTED', name='activitytype'), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('poster_id', sa.Integer(), nullable=False, related_name='posted_contracts'),
    sa.Column('hauler_id', sa.Integer(), nullable=True, related_name='accepted_contracts'),
...
def downgrade() -> None:
    ...
    sa.Column('max_participants', sa.INTEGER(), nullable=True),
    sa.Column('custom_attributes', sqlite.JSON(), nullable=True),
    sa.Column('created_at', sa.DATETIME(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('updated_at', sa.DATETIME(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
